...
public class TentAction_Processing : MonoBehaviour
{
    public GameObject prefab;
    public ActionContainer myAction;
    public void ProcessBuildAction_Tent(ActionContainer action)
    {
        myAction = action;
    ...
    private void HandlePotentialDiceRoll(int amountOfActionsSpend)
    {
        ...
        if (amountOfActionsSpend == 1)
        {
            ...
            instance.GetComponent<popProcess_Tent>().Process(this);
        }
