...
public class popProcess_Weapon : MonoBehaviour
{
    ...
    private WeaponAction_Processing myProcessor;
    ...
    public void Process(WeaponAction_Processing processor)
    {
        ...
        else
        {
            ...
            dice_Damage.texture = buildingDices[4];
        }
    }
}
